...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed class ModelData : IDataModel
    {
        ...
        [DBFieldName("gender", TargetedDbExpansion.WrathOfTheLichKingClassic, TargetedDbExpansion.WarlordsOfDraenor, DbType = (TargetedDbType.WPP | TargetedDbType.VMANGOS | TargetedDbType.CMANGOS))]
        [DBFieldName("Gender", TargetedDbExpansion.WrathOfTheLichKingClassic, TargetedDbExpansion.WarlordsOfDraenor, DbType = (TargetedDbType.TRINITY))]
